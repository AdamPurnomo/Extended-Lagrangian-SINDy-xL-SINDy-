...
state0=[1.3089;0;0;pi];
state0_test=[pi-1;0;0;pi];
...
[dData,Data]=Get_Sim_Data(@(t,y)SpherePenODE(t,y,m,L,g),state0,u,tspan,noise,Control,Shuffle);

[dData_test,Data_test]=Get_Sim_Data(@(t,y)SpherePenODE(t,y,m,L,g),state0_test,u,tspan,noise,Control,Shuffle);
...
Print_ODEs(@(t,y)SpherePenODE(t,y,m,L,g),n_state,n_control,disp_actual_ode,actual);
...
[dData_test,Data_test]=Get_Sim_Data(@(t,y)SpherePenODE(t,y,m,L,g),state0_test,u,tspan_test,Noise_test,Control,Shuffle);
