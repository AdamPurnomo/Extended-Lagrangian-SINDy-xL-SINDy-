...
state0=[ 1.1722769;-0.52146383;0;0];
...
[dData,Data]=Get_Sim_Data(@(t,y)DouPenODE(t,y,m1,m2,L1,L2,g),state0,u,tspan,noise,Control,Shuffle);

[dData_test,Data_test]=Get_Sim_Data(@(t,y)DouPenODE(t,y,m1,m2,L1,L2,g),state0_test,u,tspan,noise,Control,Shuffle);
...
Print_ODEs(@(t,y)DouPenODE(t,y,m1,m2,L1,L2,g),n_state,n_control,disp_actual_ode,actual);
...
[dData_test,Data_test]=Get_Sim_Data(@(t,y)DouPenODE(t,y,m1,m2,L1,L2,g),state0_test,u,tspan_test,Noise_test,Control,Shuffle);
